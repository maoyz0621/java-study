 ...
 * Copyright 2019 Inc.
 **/
package com.myz.java.study.opensource.ids;
...
public class SnowflakeIdWorker {
    ...
    public SnowflakeIdWorker(long workerId, long dataCenterId, boolean useHostAddress) {
        ...
        logger.info(
                String.format(
                        ...
                        TIMESTAMP_LEFT_SHIFT, DATA_CENTER_ID_BITS, DATA_CENTER_ID_BITS, SEQUENCE_BITS, workerId));
    }
    ...
    private static Long getDataCenterId() {
        try {
            int[] ints = StringUtils.toCodePoints(InetAddress.getLocalHost().getHostAddress());
            int sums = 0;
            for (int i : ints) {
                sums += i;
            }
