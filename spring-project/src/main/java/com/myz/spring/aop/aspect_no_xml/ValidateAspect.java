...
public class ValidateAspect {
     ...
     *
     */
    @After(value = "com.myz.spring.aop.aspect_no_xml.LoggingAspect.joinPointMethod()")
     ...
     * @param retVal
     */
    @AfterReturning(value = "com.myz.spring.aop.aspect_no_xml.LoggingAspect.joinPointMethod()", returning = "retVal")
     ...
     * @param e
     */
    @AfterThrowing(value = "com.myz.spring.aop.aspect_no_xml.LoggingAspect.joinPointMethod()", throwing = "e")
     ...
     * @return
     */
    @Around(value = "com.myz.spring.aop.aspect_no_xml.LoggingAspect.joinPointMethod()")
