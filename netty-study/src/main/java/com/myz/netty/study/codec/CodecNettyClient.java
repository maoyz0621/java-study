...
public class CodecNettyClient {
    ...
    public CodecNettyClient() {
        this(PORT);
    }

    public CodecNettyClient(int port) {
        this(port, HOSTNAME);
    }

    public CodecNettyClient(int port, String hostName) {
        this.port = port;
    ...
    private void main0() {
        ...
        try {
            clientBootstrap.group(worker)
                    ...
                    .handler(new CodecNettyClientInitializer());
