...
public class PackageNettyClient {
    ...
    public PackageNettyClient() {
        this(PORT);
    }

    public PackageNettyClient(int port) {
        this(port, HOSTNAME);
    }

    public PackageNettyClient(int port, String hostName) {
        this.port = port;
    ...
    private void main0() {
        ...
        try {
            clientBootstrap.group(worker)
                    ...
                    .handler(new PackageNettyClientInitializer());
