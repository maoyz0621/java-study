...
import com.myz.opensource.mapstruct.convert.expression.CarExpressionConverter;
 ...
 * @version v1.0
 */
public class CarExpressionConverterTest {
    ...
    public void testto() {
        ...
        CarDiffTypeDTO to = MapperConverterFactory.INSTANCE(CarExpressionConverter.class).to(car);
    ...
    public void testback() {
        ...
        Car car = MapperConverterFactory.INSTANCE(CarExpressionConverter.class).back(carDiffTypeDTO);
